...
Type {help_command} to get a list of available commands</b>'''
    ...
    ST_UNAUTH = '''<i>You are not an authorized user! Deploy your own KPSML-X Mirror-Leech bot.</i>'''
...
🤖 <b>Version:</b> {version}'''
    ...
    LINKS_START = """⬇️ <b><i>Task Started</i></b>
🛠️ <b>Mode:</b> {Mode}
👤 <b>By:</b> {Tag}\n\n"""
...
📊 <b><i>Bot Stats</i></b>
🖥️ <b>CPU:</b> {cpu}% | <b>F:</b> {free} [{free_p}%]
...
✂️ <b> Leech Split Size :</b> <code>{SPLIT_SIZE}</code>
