...
YT_HELP_MESSAGE = [
    """<i>Send links/files along with cmd or reply to cmd to mirror or leech ytdl supported sites on Telegram or GDrive or DDLs with different Engines like RClone or yt-dlp</i>

➲ <b><u>Available Args</u></b>:

1.  <b>-n or -name or | :</b> 📝 Rename file.
2.  <b>-z or -zip :</b> 🗜️ Zip files or Links
...
7.  <b>-opt or -options :</b> ⚙️ Attach Custom yt-dlp options to link
...
12. <b>-c or -category :</b> 🏷️ Gdrive category to Upload, Specific Name (case insensitive)
13. <b>-ud or -dump :</b> 🗑️ Dump category to Upload, Specific Name (case insensitive) or chat_id or chat_username
14. <b>-ss or -screenshots :</b> 📸 Generate Screenshots for Leeched Files
15. <b>-t or -thumb :</b> 🖼️ Custom Thumb for Specific Leech
""",
    """
...
➲ <b><i>Screenshot Generation</i></b>: -ss or -screenshots
<code>/cmd</code> link -ss number ,Screenshots for each Video File

➲ <b><i>Custom Thumbnail</i></b>: -t or -thumb
...
18. <b>-c or -category :</b> 🏷️ Gdrive category to Upload, Specific Name (case insensitive)
19. <b>-ud or -dump :</b> 🗑️ Dump category to Upload, Specific Name (case insensitive) or chat_id or chat_username
20. <b>-ss or -screenshots :</b> 📸 Generate Screenshots for Leeched Files
21. <b>-t or -thumb :</b> 🖼️ Custom Thumb for Specific Leech
""",
    """
...
This filter will parse links that it's titles contains `(1080 or 720 or 144p) and (mkv or mp4) and hevc` and doesn't contain (flv or web) and xxx` words. You can add whatever you want.
...
6. <b>-c or -category :</b> 🏷️ Gdrive category to Upload, Specific Name (case insensitive)""",
    """➲ <b><i>Links:</i></b>
...
┖ /{BotCommands.CategorySelect}: 🏷️ Select Custom category to Upload to Cloud Drive from UserTds or Bot Categories.
...
┠ /{BotCommands.CloneCommand[0]}: ♻️ Copy file/folder to Cloud Drive.
┠ /{BotCommands.CountCommand} [drive_url]: 🔢 Count file/folder of Google Drive.
┖ /{BotCommands.DeleteCommand} [drive_url]: 🗑️ Delete file/folder from Google Drive (Only Owner & Sudo).
...
<b>Bot Settings:</b>
┖ /{BotCommands.UserSetCommand[0]} or /{BotCommands.UserSetCommand[1]} [query]: ⚙️ Open User Settings (PM also)
...
<b>Bot Settings:</b>
┠ /{BotCommands.BotSetCommand[0]} or /{BotCommands.BotSetCommand[1]} [query]: 🛠️ Open Bot Settings (Only Owner & Sudo).
...
<b>Extras:</b>
┠ /{BotCommands.AddImageCommand} [url/photo]: 🖼️ Add Images in Bot
┖ /{BotCommands.ImagesCommand}: 🖼️ Generate grid of Stored Images.""",
    f"""⌬ <b><i>Miscellaneous Commands!</i></b>

<b>Extras:</b>
┠ /{BotCommands.SpeedCommand[0]} or /{BotCommands.SpeedCommand[1]}: 🚀 Check Speed in VPS/Server.
┖ /{BotCommands.MediaInfoCommand[0]} or /{BotCommands.MediaInfoCommand[1]} [url/media]: ℹ️ Generate MediaInfo of Media or DL Urls
...
default_desp = {
    ...
    "AUTO_DELETE_MESSAGE_DURATION": "⏱️ Interval of time (in seconds), after which the bot deletes it's message and command message which is expected to be viewed instantly.\n\n <b>NOTE:</b> Set to -1 to disable auto message deletion.",
    ...
    "CLONE_LIMIT": "♻️ To limit the size of Google Drive folder/file which you can clone. the default unit is GB. Int",
    "MEGA_LIMIT": "☁️ To limit the size of Mega download. the default unit is GB. Int",
    ...
    "IMAGES": "🖼️ Add multiple telgraph(graph.org) image links that are seperated by spaces.",
    ...
    "GD_INFO": "ℹ️ Description of file uploaded to gdrive using bot",
    "DELETE_LINKS": "🗑️ Delete TgLink/Magnet/File on Start of Task to Auto Clean Group. Default is False",
    "EXCEP_CHATS": "🛡️ Exception Chats which will not use Logging, chat_id separated by space. Str",
    ...
    "DATABASE_URL": "🗄️ Your Mongo Database URL (Connection string). Follow this Generate Database to generate database. Data will be saved in Database: auth and sudo users, users settings including thumbnails for each user, rss data and incomplete tasks.\n\n <b>NOTE:</b> You can always edit all settings that saved in database from the official site -> (Browse collections)",
    ...
    "SHOW_MEDIAINFO": "ℹ️ Add Button to Show MediaInfo in Leeched file. Bool",
    "SCREENSHOTS_MODE": "📸 Enable or Diable generating Screenshots via -ss arg. Default is False. Bool",
    "CAP_FONT": "🅰️ Add Custom Caption Font to Leeched Files, Available Values : b, i, u, s, code, spoiler. Reset Var to use Regular ( No Format )",
    ...
    "LEECH_FILENAME_REMNAME": "🗑️ Remove custom word from the leeched file name. Str",
    ...
    "MEDIA_GROUP": "🎞️ View Uploaded splitted file parts in media group. Default is False.",
    ...
    "RSS_DELAY": "⏱️ Time in seconds for rss refresh interval. Recommended 900 second at least. Default is 900 in sec. Int",
    ...
    "YT_DLP_OPTIONS": '⚙️ Default yt-dlp options. Check all possible options HERE or use this script to convert cli arguments to api options. Format: key:value|key:value|key:value. Add ^ before integer or float, some numbers must be numeric and some string. \nExample: "format:bv*+mergeall[vcodec=none]|nocheckcertificate:True"',
}
